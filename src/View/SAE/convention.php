...
<form method="post" action="home.php">
    <div class="containerConvention">
        ...
        <div class="container-label-input">
            ...
            <input type="text" name="addresseEtudiant" id="addresseEtudiant" placeholder="Adresse de l'étudiant" value="<?php echo htmlspecialchars($et->getNomEtudiant());?>">
        </div>
        <div class="container-label-input">
        ...
        <div class="container-label-input">
            ...
            <input type="text" name="assuranceMaladie" id="assuranceMaladie" placeholder="Assurance maladie de l'étudiant" value="Amelie">
        </div>
    </div>
