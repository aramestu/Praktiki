...
<div id="stageSection" class="container jusitfyTexte">
    ...
    <p><a href="https://www.1jeune1solution.gouv.fr/stages" class="link">https://www.1jeune1solution.gouv.fr/stages</a></p>
    ...
    <p>Consultez les consignes de communication pour vos CV/candidatures/entretiens voir <a href="https://moodle.umontpellier.fr/course/view.php?id=278" class="link">Cours Com Moodle</a></p>
...
<div id="alternanceSection" class="container jusitfyTexte">
    ...
    <p>au semestre 4: le rythme est apprécié par les entreprises. L&#8217;alternance vient en remplacement du stage. C&#8217;est l&#8217;idéal (*)</p>
    ...
    <br>
    <a href="https://drive.google.com/drive/folders/1C6qphFXaaBHH4DKaqqywgEstMovD3xNt" class="link">Les calendriers de l&#8217;alternance en BUT2 et BUT3</a><br>
    <a href="https://drive.google.com/file/d/1wphXCq6cAdcwhwTAiDW8v20xWQOAEDAJ/view?usp=share_link" class="link">Le livret de l&#8217;alternant</a><br>
    <a href="https://drive.google.com/file/d/1oUkhEWFKWemTAbnEX7fRGmZN23C3Ve1F/view?usp=sharing" class="link">Le programme nationnal BUT Info (tous parcours confondus)</a><br>
    <br>
    <h3>Rémunération</h3>
    <br>
    <p>La rémunération minimale réglementaire d’un apprenti·e est basée sur trois critères :</p>
    <p>Le critère principal est celui de l’<strong>année contractuelle</strong> &#8211; année d’exécution du contrat ;</p>
    <p>La <strong>tranche d’âge de l’apprenti au moment de l’embauche, et son évolution</strong> dans le temps, le cas échéant ;</p>
    <p>Son <strong>évolution dans le cycle de formation suivie</strong> : en principe, d’une durée désormais de 6 mois à 3 ans maximum.</p>
