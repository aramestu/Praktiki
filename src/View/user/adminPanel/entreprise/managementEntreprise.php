<div class="managementPanel">
    ...
    <div class="managementActions">
        ...
        <a class="button" id="ajoutAnnotation" href="frontController.php?controller=Annotation&action=afficherAllAnnotationEntreprise&siret=<?=rawurlencode($entreprise->getSiret())?>">Ajouter Annotation</a>
    </div>
</div>
