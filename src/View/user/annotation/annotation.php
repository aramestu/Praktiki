    ...
    <div class="HBox">
        ...
        <?php
            if(ConnexionUtilisateur::getLoginUtilisateurConnecte() == $annotation->getMailEnseignant()) {
                echo '<a id="deleteButtonOrigin"><img src="assets/images/bin-icon.png" id="deleteIcon" alt="Bin"></a>';
                echo '<a href="frontController.php?controller=Annotation&action=afficherFormulaireModificationAnnotation&idAnnotation=". <?php echo $annotation->getIdAnnotation(); ?>. ""><img src="assets/images/edit-icon.png" id="editIcon" alt="EditButton"></a>';
            }
        ?>
    </div>
