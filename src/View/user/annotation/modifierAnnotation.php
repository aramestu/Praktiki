...
<div class="container" id="annotationRelative">
    <a href="frontController.php?controller=Annotation&action=afficherAllAnnotationEntreprise&siret=<?php echo htmlspecialchars($siret)?>" id="backIconAnnotation"><img src="assets/images/back-icon.png" id="deleteIcon" alt="Bin"></a>
