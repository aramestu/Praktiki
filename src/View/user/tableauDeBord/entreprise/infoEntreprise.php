...
?>
    ...
    <form method="post" action="frontController.php?action=displayTDB&controller=TDB&tdbAction=MettreAJour">
        ...
        <div class="column">
            ...
            <input class="InputAddOn-field" type="text" value="<?= htmlspecialchars($mail) ?>" name="mail" id="email" required>
        ...
        <div class="column">
            ...
            <input class="InputAddOn-field" type="text" value="<?= htmlspecialchars($siteWeb) ?>" name="website" id="website" required>
            <label class="InputAddOn-item" for="effectif">Effectif : </label> 
            <input class="InputAddOn-field" type="text" value="<?= htmlspecialchars($effectif) ?>" name="effectif" id="effectif" required>
