...
```
cd existing_repo
git remote add origin https://gitlabinfo.iutmontp.univ-montp2.fr/starcks/sae_web_s1.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlabinfo.iutmontp.univ-montp2.fr/starcks/sae_web_s1/-/settings/integrations)
